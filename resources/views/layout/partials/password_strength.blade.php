...
<div id="popover-password">
	...
	<b class="basic-req">{{config('basic.password_three_requirement')}}</b>
	<ul class="list-unstyled">
		<li class="">
			@if($capitalChar)
	...
	@if($strengthValue == 1)
		<b class="pass_str">Password Strength: <span id="result" class="text-danger">{{ $strength }}</span></b>
		<div class="progress">
	...
	@elseif($strengthValue == 2)
		<b class="pass_str">Password Strength: <span id="result" class="good">{{ $strength }}</span></b>
		<div class="progress">
	...
	@elseif($strengthValue == 3)
		<b class="pass_str">Password Strength: <span id="result" class="better text-success">{{ $strength }}</span></b>
		<div class="progress">
	...
	@elseif($strengthValue == 4)
		<b class="pass_str">Password Strength: <span id="result" class="strong text-success">{{ $strength }}</span></b>
		<div class="progress">
			<div id="password-strength" class="progress-bar progress-bar-success"
				 role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"
				 style="width:100%">
	...
	@else
		<b class="pass_str">Password Strength: <span id="result">{{ $strength }}</span></b>
		<div class="progress">
			<div id="password-strength" class="progress-bar progress-bar-success"
				 role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"
				 style="width:0%">
